...
public class CommonsHN extends JPanel {
...
//	}
	...
	public CommonsHN(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("HN's Common File");            // NOTE: change HN to student's initials
		frame.getContentPane().add(new CommonsHN(create_Scene()));  // create an instance of the class
